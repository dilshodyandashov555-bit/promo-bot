...
async function initDatabase() {
    try {
        // Avval jadval bormi yoki yo'qligini tekshirib yaratamiz
...
// --- YO'NALISHLAR (ROUTES) TARTIBI ---

// 1. Asosiy sahifa - to'g'ridan-to'g'ri ilovaga yo'naltiradi
app.get('/', (req, res) => {
    res.redirect(TARGET_URL);
});

// 2. JSON Statistika sahifasi (Dinamik ID dan TEPADA turishi shart)
app.get('/stats', async (req, res) => {
    try {
        await initDatabase(); // Har safar kirganda bazani tekshirish
...
// 3. Ilovaga yo'naltirish va klikni hisoblash (Eng pastda bo'lishi shart)
